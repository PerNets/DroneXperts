                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center justify-between mt-1">
                            ...
                            <a
                              href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(`היי, אני מעוניין לשמוע יותר על ${result.name}`)}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="bg-green-500 hover:bg-green-600 text-white p-1.5 rounded-lg transition-all"
